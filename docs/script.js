...
ready(function () {
  /* Pubblica l'email solo a runtime per ridurre lo scraping banale. */
  var emailUser = document.body.getAttribute('data-email-user');
  var emailDomain = document.body.getAttribute('data-email-domain');
  if (emailUser && emailDomain) {
    var email = emailUser + '@' + emailDomain;
    document.querySelectorAll('[data-email-link]').forEach(function (link) {
      link.setAttribute('href', 'mailto:' + email);
      link.setAttribute('aria-label', 'Send an email to ' + email);
    });
